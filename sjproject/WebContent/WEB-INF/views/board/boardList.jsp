<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="java.util.List, com.kh.sjproject.board.model.vo.Board, com.kh.sjproject.board.model.vo.PageInfo, com.kh.sjproject.board.model.vo.Attachment"%>
						...
						<% }else{ %>
							...
							<tr>
								...
								<td class="boardTitle">
									<!-- img(썸네일) -->
									<%
										String src = request.getContextPath()+"/resources/uploadImgs/noimage.png";
									
										for(Attachment file : fList){
											if(file.getBoardId() == board.getBoardNo()){
												src = request.getContextPath() + "/resources/uploadImgs/" + file.getFileChangeName();
											}
										}
									%>
