...
public class BoardService {
	...
	public int downloadCountPlus(int fNo) throws Exception{
		
		Connection conn = getConnection();
		
		int result = new BoardDao().downloadCountPlus(conn, fNo);
		
		return result ;
	}

	public int boardCountPlus(int boardNo) throws Exception {
		
		Connection conn = getConnection();
		
		int result = new BoardDao().boardCountPlus(conn, boardNo);
