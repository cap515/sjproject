...
private Properties prop = null;
	...
	public int downloadCountPlus(Connection conn, int fNo) throws Exception{
		
		PreparedStatement pstmt = null;
		String query = prop.getProperty("downloadCountPlus");
		int result = 0;
	...
	public int boardCountPlus(Connection conn, int boardNo) throws Exception {
		
		PreparedStatement pstmt = null;
		String query = prop.getProperty("boardCountPlus");
		int result = 0;
